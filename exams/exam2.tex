...
\begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item ({\bf 10 Points}) The linked list is a data structure that
        ...
        \begin{enumerate}
          ...
          \item ({\bf 2 Points}) Clearly explain the structure of the {\tt Node} used to construct a singly linked list
          and a doubly linked list.  Your answer should include a separate graphical depiction of each of these two types of
          {\tt Node}s.
          ...
          \item ({\bf 2 Points}) Suppose that you have a properly implemented array-based queue and linked list-based
            ...
            \item ({\bf 2 Points}) What are the similarities and differences between a {\tt Queue} and the double-ended
            queue, which is also known as the {\tt Deque}?
      ...
      \item ({\bf 10 Points}) The {\tt Stack} is an abstract data type (ADT)
        ...
        \begin{enumerate}
          ...
          \item ({\bf 4 Points}) Provide a Java-based pseudo-code implementation (or, just plain pseudo-code
          ...
          \item ({\bf 4 Points}) The {\tt Stack} abstract data type provides the methods such as {\tt isEmpty}, {\tt
          ...
          \item ({\bf 2 Points}) It is possible to use an instance of the {\tt java.util.Stack} to determine whether or
          not an input string of parentheses or HTML tags is ``matching'' or, in order words, if every opening element
          has a corresponding closing element. Using natural language, describe how would you use a {\tt Stack}
      ...
      \item ({\bf 10 Points}) The authors of your textbook claim that the {\tt Stack} ADT is the ``simplest of all data
      structures.''  Answer the following questions about the {\tt Stack}.
        ...
        \begin{enumerate}
          ...
          \item ({\bf 2 Points}) You can implement a {\tt Stack} using either an array or a linked list. Two exceptions
            ...
            \item ({\bf 2 Points}) The declaration of the {\tt ArrayStack} provided by the authors of your textbook is
  ...
  public class ArrayStack<E> implements Stack<E>
            ...
            \vspace*{-.25in} \noindent What is the meaning of the aforementioned notation ``{\tt ArrayStack<E>}''? Why
            is it advisable to implement the {\tt ArrayStack} in this fashion?
