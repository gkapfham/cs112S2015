%!TEX root=cs112S2015-lab1.tex
% mainfile: cs112S2015-lab1.tex 
...
\MYHEADERS{Laboratory Assignment One}{Due: January 22, 2015}
...
\begin{enumerate}
  ...
  \item Now, you need to test to see if you can authenticate with the Bitbucket servers.  First, show the course
    ...
    with your classmates. If you are still not able to run the {\tt git clone} command, then please see the instructor.
